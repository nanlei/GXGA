<@admin.page title="每月之星新建" js=["/components/ckfinder/ckfinder.js"]>
...
<@admin.con id="datacon1">
	...
	<tr>
		<td colspan="2"><@admin.ckeditor id="articleContent" name="articleContent" value="请输入内容（每月之星）" /></td>
	</tr>
<@admin.searchArea colspan="2">
<@admin.searchRightArea>
	<@admin.actBtn name="保存" actionName="/admin/monthlystar.do?command=create" event="Save"/>
</@admin.searchRightArea>
</@admin.searchArea>
</@admin.con>
</@admin.conArea>
<@admin.conArea title="页面提示" id="form2">
本页面为每月之星新建页面，请按照上述内容进行编辑，然后点击【保存】按钮即可。<br>
<b>添加首页图片，请先保存，然后在【修改】页面进行勾添加。</b>
</@admin.conArea>
<@admin.script>
	mini.parse();
    ...
    function Save() {
    	...
    	$.ajax({
    		url: "${base}/admin/monthlystar.do?command=create",
