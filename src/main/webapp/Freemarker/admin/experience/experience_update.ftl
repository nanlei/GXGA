<@admin.page title="经验交流修改" js=["/components/ckfinder/ckfinder.js"]>
<@admin.conArea title="前台综合>>经验交流>>修改" id="form1">
...
<@admin.con id="datacon1">
	...
	<tr>
		<td colspan="2"><@admin.ckeditor id="articleContent" name="articleContent" value="${article.articleContent?default('请输入内容（经验交流）')}" /></td>
	</tr>
<@admin.searchArea colspan="2">
<@admin.searchRightArea>
	<@admin.actBtn name="保存" actionName="/admin/experience.do?command=update" event="Save"/>
</@admin.searchRightArea>
</@admin.searchArea>
</@admin.con>
</@admin.conArea>
<@admin.conArea title="页面提示" id="form2">
本页面为经验交流修改页面，请按照上述内容进行编辑，然后点击【保存】按钮即可。<br>
...
<@admin.script>
    ...
    function Save() {
    	...
    	$.ajax({
    		url: "${base}/admin/experience.do?command=update",
