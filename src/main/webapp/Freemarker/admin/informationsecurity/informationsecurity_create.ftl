<@admin.page title="信息安全新建" js=["/components/ckfinder/ckfinder.js"]>
<@admin.conArea title="前台综合>>信息安全>>新建" id="form1">
<@admin.con id="datacon1">
	...
	<tr>
		<td colspan="2"><@admin.ckeditor id="articleContent" name="articleContent" value="请输入内容（信息安全）" /></td>
	</tr>
<@admin.searchArea colspan="2">
<@admin.searchRightArea>
	<@admin.actBtn name="保存" actionName="/admin/informationsecurity.do?command=create" event="Save"/>
</@admin.searchRightArea>
</@admin.searchArea>
</@admin.con>
</@admin.conArea>
<@admin.conArea title="页面提示" id="form2">
本页面为信息安全新建页面，请按照上述内容进行编辑，然后点击【保存】按钮即可。<br>
...
<@admin.script>
    ...
    function Save() {
    	...
    	$.ajax({
    		url: "${base}/admin/informationsecurity.do?command=create",
