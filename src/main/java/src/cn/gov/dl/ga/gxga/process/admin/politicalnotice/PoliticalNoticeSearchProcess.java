...
public class PoliticalNoticeSearchProcess extends Process {
	...
	public Result process(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		PagingList articles = articleService.searchArticlesByType(request, Constant.ARTICLETYPE_POLITICALNOTICE);
