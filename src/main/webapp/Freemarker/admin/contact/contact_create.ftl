...
<@admin.conArea title="人力资源>>通讯录>>新建" id="form1">
<@admin.con id="datacon1">
	<tr>
		<td style="width:100px;"><label>姓名:</label></td>
		<td><input class="mini-textbox" required="true" name="name" style="width:150px;" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input class="mini-textbox" required="true" name="subDepartment"  style="width:150px;"/></td>
	</tr>
	<tr>
		<td><label>职位:</label></td>
		<td><input id="positionId" class="mini-combobox" required="true" name="positionId" style="width:150px;" textField="text" valueField="id"  url="${base}/admin/const.do?constant=POSITION" dataField="data" showNullItem="true" allowInput="false" /></td>
	</tr>
	<tr>
		<td><label>排序:</label></td>
		<td><input class="mini-textbox" required="true" name="contactOrder"  style="width:150px;"/></td>
	</tr>
	<tr>
...
<@admin.searchRightArea>	
	<@admin.actBtn name="保存" actionName="/admin/contact.do?command=create" event="Save"/>
</@admin.searchRightArea> 
</@admin.searchArea>
</@admin.con>
</@admin.conArea>
<@admin.conArea title="页面提示" id="form2">
本页面为通讯录新建页面，请按照上述内容和要求填写相关信息<br>
填写完成后，点击【保存】按钮即可
</@admin.conArea>
<@admin.script>
	mini.parse();
	...
	function Save() {
		...
		$.ajax({
			url: "${base}/admin/contact.do?command=create",
			data: { object: json },
			cache: false,
