...
public class MinYiWangDecorator {
	...
	public MinYiWangDecorator() {
		super();
	}

	public MinYiWangDecorator(List<Map<String, Object>> resultList) {
		super();
		this.resultList = resultList;
	}

	public MinYiWangDecorator(Map<String, Object> resultMap) {
		super();
		this.resultMap = resultMap;
	}
