...
<@admin.conArea title="分局概况>>机构设置" id="fieldset1">
<@admin.searchArea colspan="1">
<@admin.searchRightArea>
	<@admin.actBtn name="保存文章" actionName="/admin/branchoverview.do?command=updateagency" event="Save" icon="icon-save"/>
</@admin.searchRightArea>
</@admin.searchArea>
<@admin.con id="datacon1">
<#-- articleType & articleCode -->
<input class="mini-hidden" name="articleType" id="articleType" value="FJGK"/>
<input class="mini-hidden" name="articleCode" id="articleCode" value="JGSZ"/>
<table style="width:100%;">
	<tr>
		<td><span>最后更新人:</span></td><td><input class="mini-textbox" value="${agency.createByName?default('')}" allowInput="false" style="width:150px;" /></td>
		<td><span>更新时间:</span></td><td><input class="mini-textbox" value="${agency.createByTime?default('')}" allowInput="false" style="width:150px;" /></td>
		<td><span>更新IP:</span></td><td><input class="mini-textbox" value="${agency.createByIP?default('')}" allowInput="false" style="width:150px;" /></td>
		<td><span>浏览次数:</span></td><td><input class="mini-textbox" value="${agency.pageView?default('0')}" allowInput="false" style="width:150px;" /></td>
	</tr>
</table>
        ...
        <table cellpadding="0" cellspacing="0" align="center">
            <tr>
                <td align="center">
                    ...
                    <div id="imageSerachGrid" class="mini-datagrid" style="width:450px;height:180px;" showPageSize="false" showPageIndex="false" pagerStyle="padding:2px;" multiSelect="true" url="${base}/admin/image.do?command=unselectedsearch&articleType=FJGK&articleCode=JGSZ">
                ...
                <td align="center">
                    ...
                    <div id="imageSelectedList" class="mini-datagrid" style="width:450px;height:180px;" showPageSize="false" showPageIndex="false" pagerStyle="padding:2px;" multiSelect="true" url="${base}/admin/image.do?command=selectedsearch&articleType=FJGK&articleCode=JGSZ">     
                        <div property="columns">
                        	<div type="checkcolumn" ></div>
                            <div field="imageName" width="100" headerAlign="center" allowSort="true">图片名称</div>    
                            <div field="imageDescription" width="180" headerAlign="center" allowSort="true">图片描述</div>
        ...
        <table cellpadding="0" cellspacing="0" align="center">
            <tr>
                <td align="center">
                    ...
                    <div id="attachmentSerachGrid" class="mini-datagrid" style="width:450px;height:180px;" showPageSize="false" showPageIndex="false" pagerStyle="padding:2px;" multiSelect="true" url="${base}/admin/attachment.do?command=unselectedsearch&articleType=FJGK&articleCode=JGSZ">
                        <div property="columns">
                            <div type="checkcolumn" ></div>
                ...
                <td align="center">
                    ...
                    <div id="attachmentSelectedList" class="mini-datagrid" style="width:450px;height:180px;" showPageSize="false" showPageIndex="false" pagerStyle="padding:2px;" multiSelect="true" url="${base}/admin/attachment.do?command=selectedsearch&articleType=FJGK&articleCode=JGSZ">     
                        <div property="columns">
                        	<div type="checkcolumn" ></div>
                            <div field="attachmentName" width="100" headerAlign="center" allowSort="true">附件名称</div>    
                            <div field="attachmentDescription" width="180" headerAlign="center" allowSort="true">附件描述</div>
...
<@admin.ckeditor id="articleContent" name="articleContent" value="${agency.articleContent?default('请输入内容')}" />
...
<@admin.script>
	...
	function Save(){
    	$.ajax({
    		url: "${base}/admin/branchoverview.do?command=updateagency",
