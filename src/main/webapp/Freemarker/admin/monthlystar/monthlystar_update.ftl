<@admin.page title="每月之星修改" js=["/components/ckfinder/ckfinder.js"]>
<@admin.conArea title="分局概况>>每月之星>>修改" id="form1">
...
<@admin.con id="datacon1">
	...
	<tr>
		<td colspan="2"><@admin.ckeditor id="articleContent" name="articleContent" value="${article.articleContent?default('请输入内容（法律纵览）')}" /></td>
	</tr>
<@admin.searchArea colspan="2">
<@admin.searchRightArea>
	<@admin.actBtn name="保存" actionName="/admin/monthlystar.do?command=update" event="Save"/>
</@admin.searchRightArea>
</@admin.searchArea>
</@admin.con>
</@admin.conArea>
<@admin.conArea title="页面提示" id="form2">
本页面为法律修改页面，请按照上述内容进行编辑，然后点击【保存】按钮即可。<br>
若要添加首页图片，然后在【首页图片】页面进行勾选。
</@admin.conArea>
<@admin.script>
	mini.parse();
    ...
    function Save() {
    	...
    	$.ajax({
    		url: "${base}/admin/monthlystar.do?command=update",
