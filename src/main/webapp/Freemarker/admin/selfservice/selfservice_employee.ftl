<@admin.page title="信息修改">
<#if employee??>
<@admin.conArea title="个人中心>>信息修改" id="form1">
...
<@admin.con id="datacon3">
	<tr>
		...
		<td>${employee.departmentName?default('')}</td>
...
<@admin.searchRightArea>	
	<@admin.actBtn name="保存" actionName="/admin/selfservice.do?command=employeeupdate" event="Save"/>
</@admin.searchRightArea> 
</@admin.searchArea>
</@admin.con>
</@admin.conArea>
<@admin.conArea title="页面提示" id="form2">
本页面为个人信息修改页面，请按照上述内容填写相关信息<br>
填写完成后，点击【保存】按钮即可
</@admin.conArea>
<br>
<@admin.script>
	...
	function Save() {
		...
		$.ajax({
			url: "${base}/admin/selfservice.do?command=employeeupdate",
			data: { object: json },
			cache: false,
