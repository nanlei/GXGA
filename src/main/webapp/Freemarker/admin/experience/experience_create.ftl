<@admin.page title="经验交流新建" js=["/components/ckfinder/ckfinder.js"]>
<@admin.conArea title="前台综合>>经验交流>>新建" id="form1">
...
<@admin.searchRightArea>
	<@admin.actBtn name="保存" actionName="/admin/experience.do?command=create" event="Save"/>
</@admin.searchRightArea>
</@admin.searchArea>
</@admin.con>
</@admin.conArea>
<@admin.conArea title="页面提示" id="form2">
本页面为经验交流新建页面，请按照上述内容进行编辑，然后点击【保存】按钮即可。<br>
