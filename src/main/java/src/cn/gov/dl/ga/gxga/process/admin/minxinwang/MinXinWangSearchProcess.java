...
import cn.gov.dl.ga.gxga.process.admin.minxinwang.data.MinXinWangDecorator;
import cn.gov.dl.ga.gxga.service.admin.ExternalTransactionService;

public class MinXinWangSearchProcess extends Process {
	...
	public Result process(HttpServletRequest request,
		...
		PagingList transactions = externalTransactionService
				.searchExternalTransactionByType(request,
						Constant.EXTERNALTRANSACTIONTYPE_MXW);

		new MinXinWangDecorator(transactions.getList()).decorate();
