<@admin.page title="法律修改" js=["/components/ckfinder/ckfinder.js"]>
<@admin.conArea title="前台综合>>法律纵览>>修改" id="form1">
...
<@admin.searchRightArea>
	<@admin.actBtn name="保存" actionName="/admin/law.do?command=update" event="Save"/>
</@admin.searchRightArea>
</@admin.searchArea>
</@admin.con>
</@admin.conArea>
...
<@admin.script>
    ...
    function Save() {
    	...
    	$.ajax({
    		url: "${base}/admin/law.do?command=update",
