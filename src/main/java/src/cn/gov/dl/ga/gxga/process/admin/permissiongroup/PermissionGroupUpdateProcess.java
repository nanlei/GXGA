...
public class PermissionGroupUpdateProcess extends Process {
	...
	public Result process(HttpServletRequest request,
		...
		String permissionGroupId = params.get("permissionGroupId");
		...
		permissionGroupService.updatePermissionGroup(parameters);
