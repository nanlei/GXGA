...
public class MinXinWangDecorator {
	...
	public MinXinWangDecorator() {
		super();
	}

	public MinXinWangDecorator(List<Map<String, Object>> resultList) {
		super();
		this.resultList = resultList;
	}

	public MinXinWangDecorator(Map<String, Object> resultMap) {
		super();
		this.resultMap = resultMap;
	}
