<@admin.page title="部门综合文章修改">
<@admin.conArea title="部门综合>>分类文章管理>>附件明细" id="fieldset1">
        ...
        <table cellpadding="0" cellspacing="0" align="center">
            <tr>
                <td align="center">
                    ...
                    <div id="serachGrid" class="mini-datagrid" style="width:390px;height:180px;" showPageSize="false" showPageIndex="false" pagerStyle="padding:2px;" multiSelect="true" url="${base}/admin/attachment.do?command=unselectedsearch&articleId=${(articleId)?default('')}">
                ...
                <td align="center">
                    ...
                    <div id="selectedList" class="mini-datagrid" style="width:390px;height:180px;" showPageSize="false" showPageIndex="false" pagerStyle="padding:2px;" multiSelect="true" url="${base}/admin/attachment.do?command=selectedsearch&articleId=${(articleId)?default('')}">     
                        <div property="columns">
                        	<div type="checkcolumn" ></div>
                            <div field="attachmentName" width="100" headerAlign="center" allowSort="true">附件名称</div>    
                            <div field="attachmentDescription" width="180" headerAlign="center" allowSort="true">附件描述</div>
