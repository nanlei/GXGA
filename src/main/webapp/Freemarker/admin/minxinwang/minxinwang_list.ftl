...
<@admin.con id="datacon1">
	<tr>
		...
		<td>状态:</td>
		<td><input id="transactionStatus" class="mini-combobox" required="false" name="transactionStatus" style="width:150px;" textField="text" valueField="id"  url="/admin/const.do?constant=ARTICLESTATUS" dataField="data" showNullItem="true" allowInput="true" /></td>
	</tr>
	<tr>
		<td>更新时间:</td>
		<td colspan="3">
...
<@admin.searchRightArea>	
	<@admin.actBtn name="查看" actionName="/admin/minxinwang.do?command=detail" event="Detail" icon="icon-find"/>
