...
<@admin.conArea title="个人中心>>我的回音壁>>修改" id="form1">
...
<@admin.searchRightArea>	
	<@admin.actBtn name="保存" actionName="/admin/selfservice.do?command=mailboxupdate" event="Save"/>
</@admin.searchRightArea>
</@admin.searchArea>
</@admin.con>
</@admin.conArea>
...
<@admin.script>
	...
	function Save() {
    	...
    	$.ajax({
    		url: "${base}/admin/selfservice.do?command=mailboxupdate",
    		data: { object: json },
    		cache: false,
