...
<@admin.conArea title="网上办公>>回音壁>>评价" id="form1">
...
<@admin.searchRightArea>	
	<@admin.actBtn name="保存" actionName="/admin/mailbox.do?command=evaluate" event="Save"/>
</@admin.searchRightArea>
</@admin.searchArea>
</@admin.con>
</@admin.conArea>
...
<@admin.script>
	...
	function Save() {
    	...
    	$.ajax({
    		url: "${base}/admin/mailbox.do?command=evaluate",
    		data: { object: json },
    		cache: false,
