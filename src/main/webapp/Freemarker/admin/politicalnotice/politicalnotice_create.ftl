<@admin.page title="政工通知新建" js=["/components/ckfinder/ckfinder.js"]>
<@admin.conArea title="前台综合>>政工通知>>新建" id="form1">
<@admin.con id="datacon1">
	...
	<tr>
		<td colspan="2"><@admin.ckeditor id="articleContent" name="articleContent" value="请输入内容（政工通知）" /></td>
	</tr>
...
本页面为政工通知新建页面，请按照上述内容进行编辑，然后点击【保存】按钮即可。<br>
