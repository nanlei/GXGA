...
public class PubCommDecorator {
	...
	public PubCommDecorator() {
		super();
	}

	public PubCommDecorator(List<Map<String, Object>> resultList) {
		super();
		this.resultList = resultList;
	}

	public PubCommDecorator(Map<String, Object> resultMap) {
		super();
		this.resultMap = resultMap;
	}
