...
<@admin.conArea title="前台综合>>分局文件>>普通文件>>新建" id="form1">
...
<@admin.searchRightArea>
	<@admin.actBtn name="保存" actionName="/admin/branchfile.do?command=create" event="Save"/>
</@admin.searchRightArea>
</@admin.searchArea>
</@admin.con>
</@admin.conArea>
...
<@admin.script>
    ...
    function Save() {
    	...
    	$.ajax({
    		url: "${base}/admin/branchfile.do?command=create",
